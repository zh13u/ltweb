...
public class EntityDtoMapper {
    ...
    public OrderItemDto mapOrderItemToDtoPlusProductAndUser(OrderItem orderItem){
        ...
        // Add Order information including status
        if (orderItem.getOrder() != null) {
            OrderDto orderDto = new OrderDto();
            orderDto.setId(orderItem.getOrder().getId());
            orderDto.setTotalPrice(orderItem.getOrder().getTotalPrice());
            orderDto.setStatus(orderItem.getOrder().getStatus() != null ? orderItem.getOrder().getStatus().name() : null);
